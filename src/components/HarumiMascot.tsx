export function HarumiMascot({ className }: { className?: string }) {
  return (
    ...
    >
      <ellipse cx="160" cy="170" rx="120" ry="110" fill="#FFE1ED" />
      <ellipse cx="160" cy="180" rx="95" ry="88" fill="#FFFFFF" />
      <path
        d="M75 110 Q60 60 100 55 Q90 90 105 105 Z"
        fill="#FF7EB0"
      />
      <path
        d="M245 110 Q260 60 220 55 Q230 90 215 105 Z"
        fill="#FF7EB0"
      />
